    ...
    <>
      ...
      <div className="crif_p">
        ...
        <p className="text-justify">
          {" "}
          انا الموقع ادناه افوض شركة فلنسيا للسيارات بالاستعلام و/او الافصاح
          و/او تزويد و/او تبادل المعلومات الائتمانية سواء بصفتي مدينا و/او كفيلا
          و/او شريك في شركة وذلك لدى كافة البنوك و/او الشركات المرخصة وفقا
          لاحكام قانون المعلومات الائتمانية على سيبل المثال شركة كريف الاردن او
          مؤسسة الضمان الاجتماعي عن طريق اي جهة اخرى يراها مناسبة ولدى وحدة
          الشيكات المرتجعة ونظام مركزية المخاطر المصرفية لدى البنك المركزي كما
          نوافق على تزويد الجهات اعلاه بمعلومات التزاماتي الشخصية والالتزامات
          المترتبة على الشركة التي انا شريكا فيها وعن البيانات الائتمانية
          المتعلقة بي سواء بصفتي مدينا و/او كفيلا و/او شريك في شركة بما في ذلك
          على سبيل المثال لا الحصر التسهيلات الائتمانية الممنوحة لي و/او التي
          ستمنح لي من حيث نوعها و/او مقدارها و/او تاريخ استحقاقها و/او الشروط
          و/او الضمانات المتعلقة بها بكافة انواعها والية تسديدها و/او مدى
        ...
        <p>
          ...
          الى شركة فلنسيا للسيارات من الهاتف الشخصي العائد لي و اتحمل كامل
          المسوولية القانونية اذا تبين خلاف ذلك.
        </p>
      </div>
            ...
            onClick={async () => {
              ...
              if (sign.current.isEmpty()) {
                ...
                try {
                  ...
                  await axios.post("https://2229-91-186-227-54.eu.ngrok.io/signiture", fd, {
