const Info = () => {
  return (
    <>
      <div class="col-sm-12" id="kafeel_info">
        ...
        <div class="form-group form-inline ">
          <label class="control-label">
            الاسم الرباعي : <span class="star">*</span>
          </label>
          <input
            type="text"
            class="form-control kafeel-input required-kafeel width input_step1"
          ...
          <input
            type="text"
            class="form-control kafeel-input required-kafeel width"
        ...
        <div class="form-group form-inline ">
          <label class="control-label">
            الجنسية : <span class="star">*</span>
          </label>
          <select
            id="nationality_kafeel"
            class="form-control kafeel-input required-kafeel"
        ...
        <div class="form-group form-inline " id="national_number_kafeel">
          <label class="control-label">
            الرقم الوطني : <span class="star">*</span>
          </label>
          <input
            type="text"
            class="form-control kafeel-input"
            placeholder="الرقم الوطني"
            pattern="[0-9\u0660-\u0669]{10}"
            name="national_number_kafeel"
            value=""
            id="national_number_kafeel1"
            maxlength="10"
          />
        ...
        <div class="form-group form-inline " id="mobile_number_valid_kafeel">
          <label class="control-label">
            رقم الهاتف الخلوي : <span class="star">*</span>
          </label>
          <input
            type="tel"
            maxlength="10"
            class="form-control required-kafeel kafeel-input"
            placeholder="رقم الهاتف الخلوي (زين / أورانج / أمنية) "
            name="mobile_number_kafeel"
            id="mobile_number_kafeel"
      ...
      <button
        className="btn btn-primary nextBtn btn-lg pull-right step1_validation"
        type="button"
        id="otp"
      >
        التالي
